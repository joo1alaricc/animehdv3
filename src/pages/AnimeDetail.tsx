  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-8 pb-20">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="order-2 lg:order-1 lg:w-1/3 flex flex-col gap-6">
          {/* Poster */}
        ...
        <div className="order-1 lg:order-2 lg:w-2/3 space-y-8">
          <div className="bg-[#FF3B30] p-6 md:p-8 border-4 border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] text-white relative">
            ...
            <p className="text-sm md:text-xl leading-relaxed font-bold bg-black/20 p-4 md:p-6 border-l-8 border-white italic whitespace-pre-line">
              {anime.synopsis}
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              {anime.episodes && anime.episodes.length > 0 && (
                <Button variant="yellow" className="text-xl px-8 md:px-12 w-full md:w-auto" onClick={() => handleWatch(anime.episodes[0].slug)}>Watch Ep 01</Button>
              )}
               {anime.info?.aired && (
